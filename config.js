...
config.ram.allowRemoteOrigin = ['http://127.0.0.1:3000', 'http://localhost:3000','http://localhost:4200', 'http://localhost:4300','http://dev.yofferz.com','http://35.200.195.109','http://dev.yofferz.com:81'];
